...
internal class BaseType
{
	...
	public static BaseType Parse( string type, string varname = null, string callresult = null, string outStringCount = null )
	{
		...
		if ( type == "char *" ) return new FetchStringType { NativeType = type, VarName = varname, OutStringCount = outStringCount};
